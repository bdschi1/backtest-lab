"""Tests for bias.sharpe_inference — Sharpe ratio statistical inference."""
...
class TestSharpeRatioPower:
    ...
    def test_power_near_zero_when_sr1_equals_sr0(self):
        ...
        # Power should be close to alpha (= size of the test)
        assert pw < 0.15
...
class TestMultipleTesting:
    ...
    def test_holm_less_conservative_than_bonferroni(self):
        ...
        # Holm is always ≤ Bonferroni (or equal for the smallest p)
    ...
    def test_holm_preserves_order(self):
        ...
        # After sorting: [0.01, 0.03, 0.05, 0.10]
        # Holm adj should be monotone after sorting
    ...
    def test_holm_sidak_variant(self):
        ...
        # Šidák variant should be less conservative
